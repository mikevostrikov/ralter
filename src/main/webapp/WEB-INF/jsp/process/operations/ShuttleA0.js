...
if(a0==(void 0))
{
alert("You must supply the shuttle's name to create a proxy.");
this.shuttleName="";
this.formName="";
return;
}
...
if(this.formName=="")
{
alert("The given shuttle name cannot be found in a valid form.");
return;
}
}
else
...
if(a1.length==0)
{
alert("form could not be found.  Display description unsuccessful.");
return;
}
...
if(a2.length==0)
{
alert("form could not be found.  Move unsuccessful.");
return;
}
...
{
var a2="";
var a3=document.forms[a0].elements[a1];
for(var a4=0;a4<a3.length-1;a4++)
{
if(a3.options[a4].value.length>0)
{
a2=a2+
_trimString(a3.options[a4].value)
+';';
}
else
{
a2=a2+
_trimString(a3.options[a4].text)
+';';
}
}
document.forms[a0].elements[a1+':items'].value=a2;
}
...
alert("Item with the value "+a1+" was not found.");
}
