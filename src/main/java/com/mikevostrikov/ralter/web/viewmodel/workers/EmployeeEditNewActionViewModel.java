 ...
 * @author m.vostrikov
 */
public class EmployeeEditNewActionViewModel  extends ViewModel {
    ...
    public EmployeeEditNewActionViewModel(Employee employee) {
        this.employee = employee;
        this.saveEmployeeActionLink = getEmployeeActionLink(ActionParamValue.UPDATE);
        this.backActionLink = getEmployeeActionLink(ActionParamValue.MAIN);
    }
