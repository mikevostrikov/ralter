...
public class TestDBConn extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
                ...
                List result = mySession.createQuery("from Conn_test").list();
                
                out.println("<html>");
                out.println("<head>");
                out.println("<title>TestDBConn Servlet</title>");
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>TestDBConn Servlet</h1>");
                out.println("<table>");
                for (Object o : result) {
                    out.println("<tr><td>"+o.toString()+"</td><td>"+"</td></tr>");
                }
                out.println("</table>");
                out.println("</body>");
                out.println("</html>");
